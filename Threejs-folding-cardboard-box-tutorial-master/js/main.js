...
function initScene() {
    ...
    const material = new THREE.MeshStandardMaterial({
        color: new THREE.Color(0xB0916e),
...
function createCopyright() {
    ...
    ctx.textAlign = 'end';
    ctx.fillText('Aaron Enyetu', canvas.width - 30, 30);
    ctx.fillText('Crimson Ark Studio', canvas.width - 30, 70);
...
function trackLinks() {
    ...
    document.addEventListener('click', (e) => {
        ...
        if (linkCode === 1) {
            ...
            window.open('https://www.crimsonarkstudio.com/', '_blank').focus();
        }
    });
